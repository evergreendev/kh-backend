...
export const Support: CollectionConfig = {
    slug: "support",
    labels: {
        singular: "Our Support of Native Causes",
        plural: "Our Support of Native Causes"
    },
    admin: {
        useAsTitle: "title",
        hidden: ({user}) => user.role !== "admin",
        livePreview: {
            url: ({data}) => `${process.env.PAYLOAD_PUBLIC_NEXT_URL}/support/${data.slug}?draft=true&secret=${process.env.PAYLOAD_PUBLIC_DRAFT_SECRET}`,
        },
    },
    hooks: {
